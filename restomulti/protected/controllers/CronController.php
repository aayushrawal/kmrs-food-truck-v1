...
class CronController extends CController
{
	...
	public function actionMerchantNearExpiration()
	{
		...
		if ($res=$DbExt->rst($stmt)){
			...
			$tpl=getOptionA("merchant_near_expiration_tpl_content_$lang");
			$subject=getOptionA("merchant_near_expiration_tpl_subject_$lang");
		    $tpl_sms=getOptionA("merchant_near_expiration_sms_content_$lang");
